...
PARROT_CACHE_URL = 'http://stash.osgconnect.net/+sthapa/parrot_cvmfs_cache.tar.gz'
...
def setup_parrot(directory):
  ...
  cache_dir = os.path.join(directory, "parrot_cache")
  os.mkdir(cache_dir)
  download_tarball(PARROT_CACHE_URL, cache_dir)
  return parrot_path
